...
class Arc2ZenMigrator:
    ...
    def show_summary(self):
        ...
        print("• Each workspace maintains separate tabs")
        print("\n� OPEN TABS:")
        print("• Arc open tabs imported to Zen sessionstore")
        print("• **RESTART ZEN** to see your open tabs restored")
        print("• Tabs organized by workspace")
        print("📚 BOOKMARKS:")
        ...
        print()
        print("💡 NEXT STEPS:")
        print("• **Restart Zen browser** to see open tabs")
